...
def main():
    ...
    #
    # flops, params = get_model_complexity_info(model, (3, cfg.img_size, cfg.img_size))
    # split_line = '=' * 30
    # print('{0}\nInput shape: {1}\nFlops: {2}\nParams: {3}\n{0}'.format(
    #     split_line, (3, cfg.img_size, cfg.img_size), flops, params))
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            # metric = dataset.evaluate(results, seen_idx, unseen_idx, **eval_kwargs) ##modify this part (Custom Evaluation)
            metric = dataset.evaluate(results, **eval_kwargs) ##modify this part (Custom Evaluation)
